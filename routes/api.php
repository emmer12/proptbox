...
Route::group(['prefix' => 'v1'], function () {
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            Route::get('/get-all-users', 'API\AdminController@getUsers');
            Route::get('/get-all-listings', 'API\AdminController@getListings');
            Route::get('/get-all-requests', 'API\AdminController@getRequests');
            Route::get('/get-all-boosted', 'API\AdminController@getBoosted');
            Route::delete('/delete-user/{id}', 'API\AdminController@destroyUser');
            Route::delete('/delete-request/{id}', 'API\AdminController@destroyRequest');
